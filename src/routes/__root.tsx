...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered recruitment platform that screens resumes, interviews candidates, and ranks applicants automatically." },
      { property: "og:title", content: "NeuroHire AI — Autonomous Recruitment OS" },
